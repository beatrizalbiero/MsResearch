...
def load_data(path):
    """
    Create a pandas data frame with columns: 'infinitive':
    the verb's infinitive, 'vec_inf': the coded infinitive form,
    ...
    d = {'infinitive': phoneticinf, 'vec_inf': vec_inf, 'f person': phoneticI, 'vec_I': vec_I}
